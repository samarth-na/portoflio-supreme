export function ApproachSection() {
  return (
    <section className="mt-12 border-t-2 border-dark pt-8">
      <h2 className="mb-8 font-serif text-4xl italic text-dark">
        Approach & Mindset
      </h2>
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-4 animate-fade-in-up">
          <div className="border-r border-cool-divider pr-4">
            ...
            <p className="font-sans text-[11px] leading-[1.6] text-dark">
        ...
        <div className="col-span-4 animate-fade-in-up [animation-delay:0.2s]">
          <h3 className="mb-3 font-sans text-[11px] font-bold uppercase tracking-[2px] text-accent">
            🔍 Project Philosophy
          </h3>
          <p className="font-sans text-[11px] leading-[1.6] text-dark">
      ...
      <div className="mt-8 grid grid-cols-12 gap-4">
        <div className="col-span-6 animate-fade-in-up [animation-delay:0.3s]">
          <div className="newspaper-placeholder-frame newspaper-hover-lift h-[120px] w-full p-4">
            <span className="font-mono text-[10px] text-muted">
              📈 Growth & Learning
            </span>
            <p className="mt-2 font-sans text-[11px] leading-[1.5] text-dark">
        ...
        <div className="col-span-6 animate-fade-in-up [animation-delay:0.4s]">
          <div className="newspaper-placeholder-frame newspaper-hover-lift h-[120px] w-full p-4">
            <span className="font-mono text-[10px] text-muted">📬 Contact</span>
            <p className="mt-2 font-sans text-[11px] leading-[1.5] text-dark">
        ...
        <div className="grid grid-cols-12 gap-3">
          <div className="col-span-3 animate-fade-in-up [animation-delay:0.5s]">
            <div className="border border-cool-divider p-3">
              ...
              <ul className="mt-2 font-sans text-[10px] leading-[1.7] text-dark">
                <li>Next.js, React</li>
      ...
      <div className="mt-8 border-t border-cool-divider pt-6">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-4 animate-fade-in-up [animation-delay:0.9s]">
            <div className="newspaper-placeholder-frame newspaper-hover-lift h-[140px] p-3">
              <span className="font-mono text-[9px] text-muted">
                🧠 AI Coding Agent
              </span>
              <p className="mt-2 font-sans text-[10px] leading-[1.5] text-dark">
                Developer interface for managing AI coding workflows with token
                visibility and efficiency focus.
              </p>
          ...
          <div className="col-span-4 animate-fade-in-up [animation-delay:1s]">
            <div className="newspaper-placeholder-frame newspaper-hover-lift h-[140px] p-3">
              <span className="font-mono text-[9px] text-muted">
                📊 Token Analyzer
              </span>
          ...
          <div className="col-span-4 animate-fade-in-up [animation-delay:1.1s]">
            <div className="newspaper-placeholder-frame newspaper-hover-lift h-[140px] p-3">
              <span className="font-mono text-[9px] text-muted">
                🗂 Kanban App
              </span>
      ...
      <div className="mt-8 border-t border-cool-divider pt-6">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-6 animate-fade-in-up [animation-delay:1.2s]">
            <div className="border-l-2 border-accent pl-4">
              <span className="font-mono text-[9px] text-muted">
                2025 – Present
              </span>
              <h4 className="mt-1 font-sans text-[11px] font-bold text-dark">
                Independent Developer
              </h4>
              <p className="mt-1 font-sans text-[10px] leading-[1.5] text-dark">
          ...
          <div className="col-span-6 animate-fade-in-up [animation-delay:1.3s]">
            <div className="border-l-2 border-accent pl-4">
              ...
              <p className="mt-1 font-sans text-[10px] leading-[1.5] text-dark">
                Deep diving into system design, databases, cloud infrastructure
      ...
      <div className="mt-8 border-t border-dark pt-6">
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-4 col-start-5 animate-fade-in-up [animation-delay:1.4s]">
            <blockquote className="text-center font-serif text-lg italic text-dark">
