  ...
  return (
    <div className="flex flex-col">
      ...
      <article className="m-[5px_6px] mt-[6px] p-[5px_6px] animate-fade-in-up [animation-delay:0.1s]">
        ...
        <p className="mb-[6px] font-sans text-sm md:text-[12px] font-bold italic text-dark">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[6px]">
          <div>
            <ul className="m-0 list-none p-0">
              <li className="prose-bullet-item mb-[5px] font-sans text-sm md:text-[11px] leading-relaxed md:leading-[1.5] text-dark">
          ...
          <div className="flex flex-col">
            ...
            <span className="mt-[5px] inline-block text-sm md:text-[11px] text-accent underline underline-offset-[2px] transition-colors duration-200 hover:text-accent-hover">
            ...
            <div className="mt-[6px] flex items-center gap-1">
              ...
              <div className="font-sans text-sm md:text-[13px] font-bold leading-[1.2] text-dark">
                OXFAM
