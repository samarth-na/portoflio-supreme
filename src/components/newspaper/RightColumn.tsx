    ...
    <div className="flex flex-col">
      ...
      <article className="m-[5px_6px] mt-[6px] p-[5px_6px] animate-fade-in-up [animation-delay:0.1s]">
        <div className="mb-[6px]">
          <h2 className="font-heading text-[12px] font-bold uppercase tracking-[1px] text-primary">
            WORLD FAIR TRADE DAY
          </h2>
          <h3 className="mt-[2px] font-heading text-[14px] font-bold uppercase tracking-[1px] text-foreground">
            13 MEI 2017
          </h3>
        </div>
        <hr className="my-1 border-0 border-t-[0.5px] border-cool-divider" />
        <p className="mb-[6px] font-sans text-sm md:text-[12px] font-bold italic text-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[6px]">
          <div>
            <ul className="m-0 list-none p-0">
              <li className="prose-bullet-item mb-[5px] font-sans text-sm md:text-[11px] leading-relaxed md:leading-[1.5] text-foreground">
          ...
          <div className="flex flex-col">
            ...
            <span className="mt-[5px] inline-block text-sm md:text-[11px] text-primary underline underline-offset-[2px] transition-colors duration-200 hover:text-primary-hover">
