export function RightColumn() {
  return (
    <div className="flex flex-col">
      <div className="h-[60px] w-full border-b border-ink" />

      <article className="m-[5px_6px] mt-[6px] p-[5px_6px] animate-fade-in-up [animation-delay:0.1s]">
        <div className="mb-[6px]">
          <h2 className="font-sans text-[12px] font-bold uppercase tracking-[1px] text-ink">
            WORLD FAIR TRADE DAY
          </h2>
          <h3 className="mt-[2px] font-sans text-[14px] font-bold uppercase tracking-[1px] text-ink">
            13 MEI 2017
          </h3>
        </div>
        <hr className="my-1 border-0 border-t border-ink" />
        <p className="mb-[6px] font-sans text-[12px] font-bold italic text-ink">
        ...
        <div className="grid grid-cols-2 gap-[6px]">
          <div>
            <ul className="m-0 list-none p-0">
              <li className="prose-bullet-item mb-[5px] font-sans text-[11px] leading-[1.5] text-ink">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-[6px] flex items-center gap-1">
              ...
              <div className="font-sans text-[13px] font-bold leading-[1.2] text-ink">
                OXFAM
