    ...
    <div className="flex flex-col">
      <div className="relative m-[7px] flex border-b-[0.5px] border-cool-divider p-[7px] animate-fade-in-up">
        <div className="flex flex-1 flex-col justify-center">
          <blockquote className="font-sans  italic text-foreground text-fill-current">
      ...
      <article className="m-[6px_7px] p-[6px_7px] animate-fade-in-up [animation-delay:0.1s]">
        <h2 className="mb-[6px] font-heading text-[11px] font-bold uppercase tracking-[2px] text-primary">
          samarth nagar
        </h2>
        <div className="font-sans text-[11px] leading-[1.55] text-foreground">
          <p className="mb-[6px]">
          ...
          <p className="mb-[6px]">
            <span className="font-mono text-primary underline underline-offset-[2px] transition-colors duration-200 hover:text-primary-hover">
              https://github.com/samarth-na
            </span>
          </p>
        </div>
        <div className="mt-[6px] border-cool-divider border w-full">
          <div className=" newspaper-hover-lift h-[180px] w-full text-[10px]"></div>
        </div>
      </article>

      <article className="m-[6px_7px] border-t-[0.5px] border-cool-divider p-[6px_7px] animate-fade-in-up [animation-delay:0.2s]">
        <h2 className="mb-[6px] font-sans text-[11px] font-bold uppercase tracking-[2px] text-primary">
          now and future
        </h2>
        <div className="font-sans text-[11px] leading-[1.55] text-foreground">
          <p>
            ...
            <span className="text-primary underline underline-offset-[2px] transition-colors duration-200 hover:text-primary-hover">
